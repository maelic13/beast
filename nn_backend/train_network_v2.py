...
class ModelTrainer:
    @staticmethod
    def load_data(path_to_file: str, num_data: Optional[int] = None, random: bool = False, random_seed: int = 1
...
if __name__ == "__main__":
    start = time()
    positions, evaluations = ModelTrainer.load_data("evaluated_macurek.txt")
